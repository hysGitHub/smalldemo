...
import com.hys.feign.inter.IDFeign;
/**
 * 默认不能上传附件 
 */
@FeignClient(configuration={},url="http://localhost:8090",decode404=true,name="produce")
@RequestMapping("/from")
public interface FeignService extends IDFeign{
